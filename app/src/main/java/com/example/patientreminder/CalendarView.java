...
public class CalendarView extends ImageView {
	...
	private void initCalendarView() {
		...
		double dimenFactor = 1.34;
		WEEK_TOP_MARGIN = (int) (res.getDimension(R.dimen.week_top_margin) * dimenFactor);
		WEEK_LEFT_MARGIN = (int) (res.getDimension(R.dimen.week_left_margin) * dimenFactor);

		CELL_WIDTH = (int) (res.getDimension(R.dimen.cell_width) * dimenFactor);
		CELL_HEIGH = (int) (res.getDimension(R.dimen.cell_heigh) * dimenFactor);
		CELL_MARGIN_TOP = (int) (res.getDimension(R.dimen.cell_margin_top) * dimenFactor);
		CELL_MARGIN_LEFT = (int) (res.getDimension(R.dimen.cell_margin_left) * dimenFactor);

		CELL_TEXT_SIZE = (int) (res.getDimension(R.dimen.cell_text_size) * dimenFactor);
		// set background
